"""Shared-stim fair eval for Stage B im150stim (Test 6 revised).

bps=20, stim seed 12345, stim from baseline s101. Score im150stim as
fitted (prior_window_ms=150, prior_stratum=stim) and with both flags
cleared (production stim×choice T=72 / 40-bin). Baseline regular is
scored at production and on the 150+stim objective.
"""
...
OUT = BASE / "stageB_hold_s89_im150stim_eval.json"
