...
| [Faster model fitting](simulation_fit_speedups.md) | Fit to baseline loss (~0.40) in ≲1–2 h; sim bottleneck + optimizer; not analysis/session cache |
...
| [Structured nulls for choice L–R](structured_nulls_choice_lr.md) | Why label shuffle is too narrow; Harris session permutation, ActionKernel pseudo-sessions, sticky-trial exclusion; cross-arm comparison; SC regtype tables |
