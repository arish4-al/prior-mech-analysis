...
run_align = {
    ...
    'stim_duringstim_bayes': ['stim_choice_r_block_r_bayes', 'stim_choice_l_block_l_bayes',
             'stim_choice_r_block_l_bayes', 'stim_choice_l_block_r_bayes'],
    ...
    'stim_duringstim1_bayes': ['stim_block_l_bayes', 'stim_block_r_bayes'],
